...
def _add_unassisted_event(app, x, y, phase, situation, shot_type, passer, shooter, event_type, context=None) -> None:
...
def finalize_event(app, x, y, phase, situation, shot_type, passer, shooter, shot_or_goal, popup=None, context=None):
    ...
    if _is_unassisted_event(situation, shot_type):
        _add_unassisted_event(app, x, y, phase, situation, shot_type, passer, shooter, shot_or_goal, context=context)
        return
